  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _banner('assets/images/unigam/uni01.jpg', 'สินค้าแนะนำ'),

          gap(12),

          Row(
            children: [
              _promo(cs, Icons.local_shipping_outlined, 'จัดส่งฟรี', 'ส่งด่วนทันใจ'),
          ...
          _banner(
            'assets/images/unigam/uni04.jpg',
