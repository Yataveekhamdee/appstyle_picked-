...
class UnigamListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ใช้รูปที่มีจริงใน assets/images/unigam/
    const items = [
    ...
    return Scaffold(
      ...
      // ★ คง NavigationBar และยังใช้งานได้
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ราคา + ปุ่มตะกร้า (ยังคงโชว์ แต่ไม่พาไป checkout)
            Row(
              children: [
                Container(
                ...
                InkWell(
                  borderRadius: BorderRadius.circular(10),
                  onTap: () {
                    // ไม่ทำอะไร (ไม่ไป checkout) — ไอคอนยังคงไว้ตามต้องการ
                  },
                  child: Container(
